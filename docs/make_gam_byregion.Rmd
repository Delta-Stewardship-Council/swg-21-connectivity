...
alldatalook <- select(alldata0, date,total_inund_last_year, tily_fac)
str(alldata0)
...
gamd1.5 <- gam(log_chla ~ s(WTmwk, by = inundation), method = "REML", data = d.idys, family = "gaussian")
gamd1.6 <- gam(log_chla ~ s(WTmwk, by = inundation) + s(dowy, bs = "cc"), method = "REML", data = d.idys, family = "gaussian")
gamd1.7 <- gam(log_chla ~ s(log_qsdy, by = inundation) + s(WTmwk, bs = "cc"), method = "REML", data = d.idys, family = "gaussian")
gamd1.8 <- gam(log_chla ~ s(log_qsdy, by = inundation) + s(Sradmwk, bs = "cc"), method = "REML", data = d.idys, family = "gaussian")
gamd1.9 <- gam(log_chla ~ te(log_qsdy, WTmwk, by = inundation), method = "REML", data = d.idys, family = "gaussian")
gamd1.10 <- gam(log_chla ~ te(log_qsdy, Sradmwk, by = inundation), method = "REML", data = d.idys, family = "gaussian")
gamd1.11 <- gam(log_chla ~ te(log_idys, Sradmwk, by = inundation), method = "REML", data = d.idys, family = "gaussian")
gamd1.12 <- gam(log_chla ~ te(log_idys, WTmwk, by = inundation), method = "REML", data = d.idys, family = "gaussian")
gamd1.13 <- gam(log_chla ~ te(log_qsdy, dowy), method = "REML", data = d.idys, family = "gaussian")
gamd1.14 <- gam(log_chla ~ te(log_idys, dowy), method = "REML", data = d.idys, family = "gaussian")

gamd1.15 <- gam(log_chla ~ s(total_inund_last_year), method = "REML", data = d.idys, family = "gaussian")
gamd1.16 <- gam(log_chla ~ s(days_since_last_inundation), method = "REML", data = d.idys, family = "gaussian")
gamd1.17 <- gam(log_chla ~ s(diurnal_range), method = "REML", data = d.idys, family = "gaussian")
gamd1.18 <- gam(log_chla ~ s(WTrangemwk), method = "REML", data = d.idys, family = "gaussian")
gamd1.19 <- gam(log_chla ~ s(log_qsdy), method = "REML", data = d.idys, family = "gaussian")

gamd1.20 <- gam(log_chla ~ te(log_qsdy, total_inund_last_year, dowy), method = "REML", data = d.idys, family = "gaussian")
gamd1.21 <- gam(log_chla ~ te(log_qsdy, days_since_last_inundation, dowy), method = "REML", data = d.idys, family = "gaussian")
gamd1.22 <- gam(log_chla ~ te(log_qsdy, diurnal_range, dowy), method = "REML", data = d.idys, family = "gaussian")
gamd1.23 <- gam(log_chla ~ te(log_qsdy, WTrangemwk, dowy), method = "REML", data = d.idys, family = "gaussian")
gamd1.24 <- gam(log_chla ~ te(log_qsdy, WTmwk, dowy), method = "REML", data = d.idys, family = "gaussian")


AIC(gamd1.20, gamd1.21, gamd1.22, gamd1.23, gamd1.24, gamd1.13, gamd1.2)
AIC(gamd0, gamd1.15, gamd1.16, gamd1.17, gamd1.18, gamd1.19)
# total_inund_last_year, days_since_last_inundation, diurnal_range, WTrangemwk

AIC(gamd0, gamd1.0, gamd1.1, gamd1.2, gamd1.3, gamd1.4, gamd1.5, gamd1.6, gamd1.7, gamd1.8, gamd1.9, gamd1.10, gamd1.11, gamd1.12, gamd1.13, gamd1.14)
#ggplot(alldata0, aes(date, WTrangemwk)) + geom_line(aes(color = region))
#ggplot(alldata0, aes(doy1998, WTmwk)) + geom_line(aes(color = region))
...
gamyo1.15 <- gam(log_chla ~ s(total_inund_last_year, k = 6), method = "REML", data = yo.idys, family = "gaussian")
gamyo1.16 <- gam(log_chla ~ s(days_since_last_inundation), method = "REML", data = yo.idys, family = "gaussian")
...
#gamyo1.23b <- gam(log_chla ~ te(log_qsdy, WTrangemwk, dowy, by = inundation), method = "REML", data = yo.idys, family = "gaussian")
gamyo1.24 <- gam(log_chla ~ te(log_qsdy, WTmwk, dowy), method = "REML", data = yo.idys, family = "gaussian")

ggplot(yo.idys) + geom_point(aes(dowy, WTrangemwk, color = inundation))
# AIC
...
tily.75 = quantile(yo.idys$total_inund_last_year, probs = 0.75)
...
upstream_s_long <- pivot_longer(u.idys, cols = c(log_idys,t_qsdy,diurnal_range:Sradmwk), names_to = "Parameter", values_to = "Value")
...
gamu1.4 <- gam(log_chla ~ s(log_qsdy) + s(WTmwk), method = "REML", data = u.idys, family = "gaussian")
gamu1.5 <- gam(log_chla ~ s(log_qsdy) + s(WTmwk) + s(dowy, bs = "cc"), method = "REML", data = u.idys, family = "gaussian")
gamu1.6 <- gam(log_chla ~ te(log_qsdy, dowy), method = "REML", data = u.idys, family = "gaussian")
gamu1.7 <- gam(log_chla ~ te(log_qsdy, WTmwk, dowy), method = "REML", data = u.idys, family = "gaussian")
gamu1.8 <- gam(log_chla ~ te(log_qsdy, WTrangemwk, dowy), method = "REML", data = u.idys, family = "gaussian")
gamu1.9 <- gam(log_chla ~ te(log_qsdy, diurnal_range, dowy), method = "REML", data = u.idys, family = "gaussian")
gamu1.10 <- gam(log_chla ~ te(log_qsdy, WTmwk), method = "REML", data = u.idys, family = "gaussian")
gamu1.11 <- gam(log_chla ~ te(log_qsdy, WTrangemwk), method = "REML", data = u.idys, family = "gaussian")
gamu1.12 <- gam(log_chla ~ te(log_qsdy, diurnal_range), method = "REML", data = u.idys, family = "gaussian")
