...
gamd6c <- gam(log_chla ~ te(log_qsdy, WTmwk, by = inund_fac2) + s(station, bs = "re"), method = "REML", data = downstream, family = "gaussian")
summary(gamd6c)
gam.vcomp(gamd6c)
#####################
...
rownames(chl.mat.none) = seq.none.lqsdy
colnames(chl.mat.none) = seq.none.wtmwk
rownames(chl.mat.shrt) = seq.none.lqsdy
colnames(chl.mat.shrt) = seq.none.wtmwk
rownames(chl.mat.long) = seq.none.lqsdy
colnames(chl.mat.long) = seq.none.wtmwk
...
col_range = colorRampPalette(c("rosybrown4", "darkred", "tomato1", "gray85", "steelblue1", "royalblue", "royalblue3", "darkblue", "purple4"))
