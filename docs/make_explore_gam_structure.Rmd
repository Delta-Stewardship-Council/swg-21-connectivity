...
acf(resid)
pacf(resid)
plot(x$log_qsdy, resid, xlab = "Flow same day",   ylab = "Residuals")
plot(x$log_idys, resid, xlab = "Inundation days", ylab = "Residuals")
...
AIC(gam0, gam1.0, gam1.1, gam1.2, gam1.3, gam1.4, gam1.5)
