...
#~~   Last Modified by JW Gaeta  on April 23, 2025
#########################################################################
#########################################################################
...
load(here("data_clean/data_gam_results.Rdata"))
...
save(yolo.none_arr_red , yolo.shrt_arr_red, yolo.long_arr_red, up.none_arr_red,
     ...
     do.temp_range, file=here("manuscript_code/data_clean/all_GAM_outputs.RData"))
