...
# Make inundation = 0 (not inundated) as category 1, and inundation = short (inundation < 3wks) as category 2, inundation = long (inundation > 3wks) as category 3
...
# Run model
jm <- jags.model("bayes_models/mod20c_yolo_inund_poss_want/sam_model.JAGS",
                 data = datlist,
                 inits = initslist,
                 n.chains = 3)
...
load("bayes_models/mod20c_yolo_inund_poss_want/run_20220902.rda")
...
save(saved.state, file = "bayes_models/mod20c_yolo_inund_poss_want/inits/sstate_20220902.Rda")
...
coda_sum %>%
  ...
  theme_bw()
ggsave(filename = "bayes_models/mod20c_yolo_inund_poss_want/fig_out/slope_of_beta_inund_20220902.png",
...
coda_sum %>%
  ...
  theme_bw()
ggsave(filename = "bayes_models/mod20c_yolo_inund_poss_want/fig_out/slope_of_betas_qant_20220902.png",
       dpi=300, width = 11, height = 8)
...
coda_sum %>%
  ...
  theme_bw()
ggsave(filename = "bayes_models/mod20c_yolo_inund_poss_want/fig_out/weights_of_qant_202200902.png",
       dpi=300, width = 10, height = 8)

# save model
save(jm_coda, coda_sum, file = "bayes_models/mod20c_yolo_inund_poss_want/run_20220902.rda")

# save model summary
sink("bayes_models/mod20c_yolo_inund_poss_want/fig_out/jm_coda_summary.txt")
summary(jm_coda)
sink()
...
ggsave(filename = "bayes_models/mod20c_yolo_inund_poss_want/fig_out/pred_vs_obs_20220902.png",
       dpi=300, width = 10, height = 8)
...
ggsave(filename = "bayes_models/mod20c_yolo_inund_poss_want/fig_out/pred_obs_time_20220902.png",
       dpi=300, width = 10, height = 8)
