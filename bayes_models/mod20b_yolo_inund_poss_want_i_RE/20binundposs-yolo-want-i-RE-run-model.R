...
# Run model
jm <- jags.model("bayes_models/mod20b_yolo_inund_poss_want_i_RE/sam_model2.JAGS",
                 data = datlist,
                 inits = initslist,
                 n.chains = 3)
...
load("bayes_models/mod20b_yolo_inund_poss_want_i_RE/run_20220908.rda")
...
save(saved.state, file = "bayes_models/mod20b_yolo_inund_poss_want_i_RE/inits/sstate_20220908.Rda")
...
coda_sum %>%
  ...
  theme_bw()
ggsave(filename = "bayes_models/mod20b_yolo_inund_poss_want_i_RE/fig_out/slope_of_beta_inund_20220908.png",
...
coda_sum %>%
  ...
  theme_bw()
ggsave(filename = "bayes_models/mod20b_yolo_inund_poss_want_i_RE/fig_out/slope_of_betas_qant_20220908.png",
       dpi=300, width = 11, height = 8)
...
coda_sum %>%
  ...
  theme_bw()
ggsave(filename = "bayes_models/mod20b_yolo_inund_poss_want_i_RE/fig_out/weights_of_qant_202200908.png",
       dpi=300, width = 10, height = 8)

# save model
save(jm_coda, coda_sum, file = "bayes_models/mod20b_yolo_inund_poss_want_i_RE/run_20220908.rda")

# save model summary
sink("bayes_models/mod20b_yolo_inund_poss_want_i_RE/fig_out/jm_coda_summary.txt")
summary(jm_coda)
sink()
...
ggsave(filename = "bayes_models/mod20b_yolo_inund_poss_want_i_RE/fig_out/pred_vs_obs_20220908.png",
       dpi=300, width = 10, height = 8)
...
ggsave(filename = "bayes_models/mod20b_yolo_inund_poss_want_i_RE/fig_out/pred_obs_time_20220908.png",
       dpi=300, width = 10, height = 8)
