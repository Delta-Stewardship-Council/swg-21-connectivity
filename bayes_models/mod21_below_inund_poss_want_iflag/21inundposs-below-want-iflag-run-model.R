...
# Run model
jm <- jags.model("bayes_models/mod21_below_inund_poss_want_iflag/sam_model.JAGS",
                 data = datlist,
                 inits = initslist,
                 n.chains = 3)
...
load("bayes_models/mod21_below_inund_poss_want_iflag/run_20220906.rda")
...
save(saved.state, file = "bayes_models/mod21_below_inund_poss_want_iflag/inits/sstate_20220906.Rda")
...
coda_sum %>%
  ...
  theme_bw()
ggsave(filename = "bayes_models/mod21_below_inund_poss_want_iflag/fig_out/slope_of_beta_inund_20220906.png",
...
coda_sum %>%
  ...
  theme_bw()
ggsave(filename = "bayes_models/mod21_below_inund_poss_want_iflag/fig_out/slope_of_betas_qant_20220906.png",
       dpi=300, width = 11, height = 8)
...
coda_sum %>%
  ...
  theme_bw()
ggsave(filename = "bayes_models/mod21_below_inund_poss_want_iflag/fig_out/weights_of_qant_20220906.png",
       dpi=300, width = 10, height = 8)

# save model
save(jm_coda, coda_sum, file = "bayes_models/mod21_below_inund_poss_want_iflag/run_20220906.rda")

# save model summary
sink("bayes_models/mod21_below_inund_poss_want_iflag/fig_out/jm_coda_summary.txt")
summary(jm_coda)
sink()
...
ggsave(filename = "bayes_models/mod21_below_inund_poss_want_iflag/fig_out/pred_vs_obs_20220906.png",
       dpi=300, width = 10, height = 8)
...
ggsave(filename = "bayes_models/mod21_below_inund_poss_want_iflag/fig_out/pred_obs_time_20220906.png",
       dpi=300, width = 10, height = 8)
