...
f_make_bayes_mod06_dataset <- function() {
  ...
  write_rds(chla_all, "bayes_models/mod06/mod_chla_data.rds")
  write_rds(covars, file = "bayes_models/mod06/mod_covariates_complete.rds")
