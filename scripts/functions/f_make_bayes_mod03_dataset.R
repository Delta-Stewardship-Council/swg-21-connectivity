...
f_make_bayes_mod03_dataset <- function() {
 ...
 ## FLOW: Get Verona Flow -----------
  ...
  write_rds(chla_all, "bayes_models/mod03/mod_chla_data.rds")
  write_rds(covars, file = "bayes_models/mod03/mod_covariates_complete.rds")
