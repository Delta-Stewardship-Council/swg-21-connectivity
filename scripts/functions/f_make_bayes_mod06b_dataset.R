...
f_make_bayes_mod06b_dataset <- function() {
  ...
  write_rds(chla_all, "bayes_models/mod06b/mod_chla_data.rds")
  write_rds(covars, file = "bayes_models/mod06b/mod_covariates_complete.rds")
