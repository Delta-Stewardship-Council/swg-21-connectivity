...
f_make_bayes_mod14inundposs_sincelast_inter_dataset <- function() {
  ...
  covars_yolo_scaled <- covars_yolo_1 %>%
    mutate(Q = scale(Q_sday),
           ...
           days_since_last_inundation = scale(days_since_last_inundation),
  ...
  covars_yolo_scaled$days_since_last_inundation <- as.numeric(covars_yolo_scaled$days_since_last_inundation)
  ...
  write_rds(chla_yolo, "bayes_models/mod14_yolo_inund_poss_sincelast_inter/mod_chla_data.rds")
  write_rds(covars_yolo_scaled, file = "bayes_models/mod14_yolo_inund_poss_sincelast_inter/mod_covariates_complete.rds")
