...
f_make_bayes_mod13_below_inundposs_dataset <- function() {
  ...
  write_rds(chla_all, "bayes_models/mod13_below_inund_poss/mod_chla_data.rds")
  write_rds(covars_scaled, file = "bayes_models/mod13_below_inund_poss/mod_covariates_complete.rds")
