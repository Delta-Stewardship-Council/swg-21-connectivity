...
f_make_bayes_mod17inundposs_wtemponly_dataset <- function() {
  ...
  write_rds(chla_yolo, "bayes_models/mod17_yolo_inund_poss_wtemponly/mod_chla_data.rds")
  write_rds(covars_yolo_scaled, file = "bayes_models/mod17_yolo_inund_poss_wtemponly/mod_covariates_complete.rds")
