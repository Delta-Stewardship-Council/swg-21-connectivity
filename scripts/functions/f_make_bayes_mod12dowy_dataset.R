...
f_make_bayes_mod12dowy_dataset <- function() {
  ...
  write_rds(chla_yolo, "bayes_models/mod12/mod_chla_data.rds")
  write_rds(covars_yolo_scaled, file = "bayes_models/mod12/mod_covariates_complete.rds")
