...
f_make_bayes_mod02_dataset <- function() {
 ...
 ## FLOW: Get Verona Flow -----------
  ...
  # paste_topped = # of topped or inundated days in past 31 days
  ...
  write_rds(chla_all, "bayes_models/mod02/mod_chla_data.rds")
  write_rds(covars, file = "bayes_models/mod02/mod_covariates_complete.rds")
