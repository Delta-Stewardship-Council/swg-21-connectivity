...
f_make_bayes_mod14inundposs_wtemprange_inter_dataset <- function() {
  ...
  write_rds(chla_yolo, "bayes_models/mod14_yolo_inund_poss_wtemprange_inter/mod_chla_data.rds")
  write_rds(covars_yolo_scaled, file = "bayes_models/mod14_yolo_inund_poss_wtemprange_inter/mod_covariates_complete.rds")
