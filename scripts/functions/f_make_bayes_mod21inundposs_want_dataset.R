...
f_make_bayes_mod21inundposs_want_dataset <- function() {
  ...
  covars_below_scaled$Wtmday <- as.numeric(covars_below_scaled$Wtmday)
  ...
  write_rds(chla_below, "bayes_models/mod21_below_inund_poss_want_i/mod_chla_data.rds")
  write_rds(covars_below_scaled, file = "bayes_models/mod21_below_inund_poss_want_i/mod_covariates_complete.rds")
