...
f_make_bayes_mod05_dataset <- function() {
 ...
 ## FLOW: Get Verona Flow -----------
  ...
  # make 7-day average of daily mean for Rad
  ...
  write_rds(chla_all, "bayes_models/mod05/mod_chla_data.rds")
  write_rds(covars, file = "bayes_models/mod05/mod_covariates_complete.rds")
