#temporary file to import the 2023 discretewq dataset
#the file is nearly identical to the f_clean_discretewq script
#the output of this file is used in the R/compare_chla2 script
...
library(lubridate)
  ...
  write_csv(wq, "data_publication/data_clean/new_clean_discretewq.csv")
