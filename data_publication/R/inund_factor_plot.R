...
# plot
png("data_publication/figures/inun_factor.png", width = 8, height = 10, units = "in", pointsize = 12,
    bg = "white", res = 600)

par(mfrow=c(1,1))
plot(inun_event$wy_day, inun_event$inund_days, col = inun_event$color,
...
legend("topleft", c("1999", "2000", "2002", "2003", "2004", "2005", "2006", "2010", "2011", "2013", "2016", "2017", "2018", "2019", "mean", "median"),
       col = c("#A6CEE3", "#1F78B4", "#B2DF8A", "#33A02C", "#FB9A99", "#E31A1C", "#FFFF99", "#FDBF6F", "#FF7F00","#B15928", "#CAB2D6", "#6A3D9A",  "#666666", "black", "black", "black"),
       pch = c(16,16,16,16,16,16,16,16,16,16,16,16,16,16,NA,NA), lty = c(NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA, 2, 4))
